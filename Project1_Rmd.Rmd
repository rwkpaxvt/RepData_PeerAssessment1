...
This is an R Markdown document for Project 1 in the Reproducible Research Coursera Class.

##Read in the data, plot the total number of steps per day, then save out the plot
```{r}
...
##Calculate the mean and median steps per day the plot the mean number of steps by interval
```{r}
...
##Fill in all missing values and recalculate the mean and median steps per day
...
##Calculate step trends by weekday and weekend
```{r}
#Calculate mean and median by day
